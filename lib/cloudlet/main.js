...
var subscriptionPatternMatch   = new RegExp(/^s_[a-z0-9]{32}-[0-9]{1,10}$/);
var subscriptionPatternExtract = new RegExp(/s_[a-z0-9]{32}-[0-9]{1,10}/);
...
var isSubscriptionId = function(path){

   return subscriptionPatternMatch.test(path);
...
var generateUUID = function(type) {
   ...
   case "object":
      ...
      str     = '0' + hex.substring(0, 7) + '-' + hex.substring(7, 12) + '-4xxx-yxxx-xxxxxxxxxxxx'
      break;
   case "attachment":
      var hex = date.toString(16)
      str     = 'a' + hex.substring(0, 7) + '-' + hex.substring(7, 12) + '-4xxx-yxxx-xxxxxxxxxxxx'
      break;
   }
...
module.exports.isSubscriptionId    = isSubscriptionId;
